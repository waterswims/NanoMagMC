...
template <class T> T** alloc_2darr(int size_m, int size_n);

template <class T> T*** alloc_3darr(int size_m, int size_n, int size_p);

template <class T> void dealloc_1darr(T* arr);

template <class T> void dealloc_2darr(int size_m, T** arr);

template <class T> void dealloc_3darr(int size_m, int size_n, T*** arr);
