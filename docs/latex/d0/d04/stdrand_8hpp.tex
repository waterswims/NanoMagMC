...
\begin{center}
\leavevmode
\includegraphics[width=187pt]{da/dbb/stdrand_8hpp__incl}
\end{center}
\end{figure}
\subsection*{Classes}
...
\begin{DoxyCompactList}\small\item\em Generator for random numbers on a normal distribution. \end{DoxyCompactList}\end{DoxyCompactItemize}
